...
const DisplayCompletedTasksCard = ({ task }) => {
    ...
    return (
        <div>
            <article className="flex flex-col bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-xl">
                ...
                <div className="flex flex-col flex-1 px-6 py-4">
                    ...
                    <div>
                        <p className='text-gray-300 text-sm'>Posted By: {userEmail}</p>
                        <p className='text-gray-300 text-sm'>Posted On: {taskPostedDate}</p>
                    </div>
                </div>
                <div className='w-full py-[10px] font-semibold  text-white  bg-blue-800 rounded-md'>
